...
class ProjectsList extends Component {
    constructor(){
        ...
        this.state={
            ...
            dtOptions: {
                ...
                ajax:{
                    url:GlobalVariables.URLBACKBASE+"/api/constructabilityProject/created",
                    dataSrc:""
                },
                columns:[
                    {
                ...
                columnDefs : [
                    {
                       ...
                       createdCell : (td, cellData, project, row, col) => {
                        ...
                        ReactDOM.render(
                            <div className="badge badge-success" onClick={()=>this.goToProject(project)} >
                                     {project.ref}
                             </div>
                             ,td)
    ...
    goToProject=(project)=>{
        this.props.history.push('/projectdetails/'+project.id);
    }
    ...
    componentDidMount(){
        // axios.get('http://127.0.0.1:9090/api/constructabilityProject')
        // .then(response=>{
            ...
            <ContentWrapper>
                <div className="content-heading">
                    ...
                    <div className="ml-auto">
                        <Link to="/projectsInitialized">
                            <Button outline color="primary" type="button">Projects Initialized</Button>
                        </Link>
                    </div>
                </div>
